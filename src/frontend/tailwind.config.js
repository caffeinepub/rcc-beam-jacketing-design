  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        success: { DEFAULT: "oklch(var(--success) / <alpha-value>)", foreground: "oklch(var(--success-foreground))" },
      ...
      boxShadow: {
        card: "0 1px 3px 0 rgba(30,42,53,0.08), 0 1px 2px -1px rgba(30,42,53,0.06)",
        "card-hover": "0 4px 12px 0 rgba(30,42,53,0.12)",
