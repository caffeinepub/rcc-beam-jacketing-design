...
export class Backend implements backendInterface {
    ...
    async getCalculationByDesignation(arg0: string): Promise<BeamResult> {
        if (this.processError) {
            try {
                const result = await this.actor.getCalculationByDesignation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getCalculations(): Promise<Array<BeamResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCalculations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeCalculation(arg0: BeamInput, arg1: BeamCalculation): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeCalculation(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
